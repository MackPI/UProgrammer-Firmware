...
void setupIoPins()
{
	...
	// ΣΔ pulse stream for Voltage pump
	GPIO_OUTPUT_SET(4, 1);
	...
	//GPIO6 SPI SCLK
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_SD_DATA0_U, FUNC_SPIQ);
	//GPIO7 SPI MISO
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_SD_DATA1_U, FUNC_SPID);
	//GPIO8 SPI MOSI
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_SD_DATA2_U, FUNC_SPIHD);
	//GPIO9 SPI QIO2
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_SD_DATA3_U, FUNC_SPIWP);
	//GPIO10 SPI QIO3
